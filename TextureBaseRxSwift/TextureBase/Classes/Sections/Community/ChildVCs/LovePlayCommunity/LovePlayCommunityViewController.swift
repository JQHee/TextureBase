//
//  LovePlayCommunityViewController.swift
//  TextureBase
//
...
// MARK: - 爱玩社区
class LovePlayCommunityViewController: ASViewController<ASDisplayNode> {
    ...
    private func requestListData() {
        let request = LovePlayCommunityRequest()
        kaneVM.looadLovePlayCommunity(r: request, successBlock: { [weak self] in
...
extension LovePlayCommunityViewController: ASCollectionDataSource {
...
extension LovePlayCommunityViewController: UICollectionViewDelegateFlowLayout {
