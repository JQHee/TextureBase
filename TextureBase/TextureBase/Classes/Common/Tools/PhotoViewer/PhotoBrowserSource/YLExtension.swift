...
extension UIView {
    ...
    func addConstraints(attributes attr1s: [NSLayoutConstraint.Attribute],
                        toItem: Any?,
    ...
    func updateConstraints(attributes attr1s: [NSLayoutConstraint.Attribute],
                           toItem: Any?,
                           attributes attr2s: [NSLayoutConstraint.Attribute]?,
                           constant: CGFloat) {
        for (i,attr1) in attr1s.enumerated() {
    ...
    /// 修改约束
    func updateConstraint(attribute attr1: NSLayoutConstraint.Attribute,
                          toItem: Any?,
                          attribute attr2: NSLayoutConstraint.Attribute,
                          constant: CGFloat) {
        updateConstraint(attribute: attr1, relatedBy: .equal, toItem: toItem, attribute: attr2, multiplier: 1, constant: constant)
    ...
    func removeConstraints(attributes attr1s: [NSLayoutConstraint.Attribute],
                           toItem: Any?,
                           attributes attr2s: [NSLayoutConstraint.Attribute]?) {
        for (i,attr1) in attr1s.enumerated() {
            let attr2 = attr2s == nil ? attr1:attr2s![i]
    ...
    /// 删除约束
    func removeConstraint(attribute attr1: NSLayoutConstraint.Attribute,
                          toItem: Any?,
                          attribute attr2: NSLayoutConstraint.Attribute) {
